...
async function fetchBotReply(outline) {
  ...
  console.log(response, "in fetchBotReply");
...
async function fetchSynopsis(outline) {
  ...
  console.log(response, "in fetchSynopsis");
...
async function fetchTitle(synopsis) {
  ...
  console.log(response, "In fetchTitle");
...
async function fetchStars(synopsis) {
  ...
  console.log(response, "in fetchStars");
...
async function fetchImagePromt(title, synopsis) {
  ...
  console.log(response, "In fetchImagePromt");
...
async function fetchImageUrl(imagePrompt) {
  ...
  document.getElementById("view-pitch-btn").addEventListener("click", () => {
    ...
    console.log("moveiBoss line reached");
